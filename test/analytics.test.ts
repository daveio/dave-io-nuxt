...
import { parseAnalyticsResults, aggregateAnalyticsMetrics, getTimeRangeBoundaries, isBot } from "~/server/utils/analytics"
      ...
      sampleEvents = [
        {
          type: "redirect",
          timestamp: "2024-01-01T12:00:00Z",
          cloudflare: { ray: "abc", country: "US", ip: "192.168.1.1", datacenter: "abc", userAgent: "Chrome", requestUrl: "/" },
          data: { slug: "gh", destinationUrl: "https://github.com", clickCount: 3 }
        },
        {
          type: "auth",
          timestamp: "2024-01-01T12:01:00Z",
          cloudflare: { ray: "def", country: "CA", ip: "192.168.1.2", datacenter: "def", userAgent: "Firefox", requestUrl: "/" },
          data: { success: true, tokenSubject: "user1" }
        },
        {
          type: "auth",
          timestamp: "2024-01-01T12:02:00Z",
          cloudflare: { ray: "ghi", country: "US", ip: "192.168.1.1", datacenter: "ghi", userAgent: "Safari", requestUrl: "/" },
          data: { success: false, tokenSubject: "user2" }
        },
        {
          type: "ai",
          timestamp: "2024-01-01T12:03:00Z",
          cloudflare: { ray: "jkl", country: "GB", ip: "192.168.1.3", datacenter: "jkl", userAgent: "Chrome", requestUrl: "/" },
          data: { operation: "alt-text", method: "POST", imageSource: "test.jpg", processingTimeMs: 1200, imageSizeBytes: 1024 }
        }
      ]
    })
